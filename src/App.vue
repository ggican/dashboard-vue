          ...
          <ul>
            <li>
              <router-link
                ...
                href="#"
              >
                <span class="text-sidebar-text items-center">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                ...
                <span class="ml-2 font-normal text-sidebar-text">About</span>
              </router-link>
            </li>
            <li>
              <router-link
              ...
              >
                ...
                <span class="ml-2 font-normal text-sidebar-text">User</span>
              </router-link>
            </li>
          </ul>
        </div>
